...
int main() {
    ...
    vector<glm::vec3> stones
            {
                    glm::vec3(-1.5f, -4.0f, -4.48f),
                    glm::vec3( 1.5f, -4.0f, 4.51f),
                    glm::vec3( 0.0f, -4.3f, 10.7f),
    ...
    //  unsigned int mapa = loadTexture(FileSystem::getPath("resources/textures/mapa.jpg").c_str());
...
//ako ne radi ovaj blok zakomentarisi sledeci odkomentarisi
        glClearColor(programState->clearColor.r, programState->clearColor.g, programState->clearColor.b, 1.0f);
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
